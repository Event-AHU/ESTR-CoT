...
class LmdbDataset(Dataset):
    def __init__(
        self, vis_processor=None, text_processor=None, vis_root=None, csv_root=None, ann_paths=[], lmdb_paths=[]
    ):
        """
...
class BaseDataset(Dataset):
    def __init__(
        self, vis_processor=None, text_processor=None, vis_root=None, csv_root=None, ann_paths=[]
    ):
        """
        vis_root (string): Root directory of images (e.g. coco/images/)
