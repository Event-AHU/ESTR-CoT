...
class EventOCRBuilder(BaseDatasetBuilder):
    ...
    def build_datasets(self):
        ...
        # create datasets CoT_train_v7.json  stage3_mixed_244.json  CoT_train_2model.json
        ann_paths = [os.path.join(storage_path, 'CoT_train_v7.json')]
...
# @registry.register_builder("MJ_ST")
# class MJBuilder(BaseDatasetBuilder):
#     train_dataset_cls = MJ_ST_Dataset

#     DATASET_CONFIG_DICT = {
#         "default": "/wangx/BLIVA/bliva/configs/datasets/MJ_ST/defaults.yaml",
#     }
...
#         vis_root = build_info.vis_root
#         csv_root = build_info.csv_root
#         lmdb_paths = build_info.lmdb_paths
